...
EVAL_DIR = "eval_sequences"        # ONLY ONE EVAL SOURCE
SAVE_MODEL_PATH = "/home/gl-961/ASH/python_examples/stock_forecasting/checkpoints/epoch_300.pt"
...
# ============================================================
# DELETE OUTPUT FOLDERS IF EXIST
# ============================================================
...
def plot_heatmap(true, pred, path, title, bins=20):
...
# ============================================================
# GLOBAL EVALUATION (ONLY ONE SOURCE)
# ============================================================
...
def evaluate(folder, prefix):
    ...
    if not files:
        print(f"No evaluation files found in {folder}")
        return
    ...
    print(f"\nEvaluating {prefix}... {len(files)} files found.\n")
    ...
    pd.DataFrame([ret_metrics]).to_csv(
        f"{RETURN_DIR}/{prefix}_return_metrics.csv",
        index=False
    )

    print(f"✓ Finished evaluation: {prefix}\n")


# ============================================================
# RUN EVALUATION ONLY ON EVAL_DIR
# ============================================================
